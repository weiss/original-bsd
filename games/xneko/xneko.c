 ...
 *	disco	!D!!X11 s.xneko.c/%K%+%k!&%"8.1P%$%6!<
 *
 ...
 *!!!!!!!!$G$b Idle 90 !A 95% $H$J$j!"%7%9s.xneko.c`#C#P#U$r 5 !A 10%
 ...
 *!!System (Machine):
 *
 *!!!!K\@(#)xneko.c	8.1m%0%i%`$NF0:n$r3NG'$7$?%7%9s.xneko.c`9=@.$O0J2<$NDL$j!#
 *
...
/*
 *	X11 G- 0C10/14/12^129W18:45:52!%$%k0lMw!'
 *
 *		"icon.xbm"		!D!!%"%$%3%s
 *		"cursor.xbm"		!D!!%+!<%=%k
...
#define	BITMAP_WIDTH		32	/* #1%-%c%i%/%?$NI} (17:01:51/%;%k) */
#define	BITMAP_HEIGHT		32	/* #1%-%c%i%/%?$N9b$5 (17:01:51/%;%k) */

#define	WINDOW_WIDTH		320	/* %&%#%s8.1&$NI} (17:01:51/%;%k) */
#define	WINDOW_HEIGHT		256	/* %&%#%s8.1&$N9b$5 (17:01:51/%;%k) */
...
#define	INTERVAL		125000L		/* %$%s%?!</usr/home/csrg/sccs/games/xneko/SCCS/s.xneko.ck%?%$%` */
...
/*
 *	%0%m!</usr/home/csrg/sccs/games/xneko/SCCS/s.xneko.ckJQ?t
 */
...
/*--------------------------------------------------------------
 *
 *	%$%s%?!</usr/home/csrg/sccs/games/xneko/SCCS/s.xneko.ck
 *
...
/*--------------------------------------------------------------
 *
 *	G-0\F0s.xneko.c9%H!J05/31/93P14670MQ!K
 *
 *--------------------------------------------------------------*/
...
NekoMoveTest()
{
    ...
    fprintf( stderr, "\n" );
    fprintf( stderr, "G-$N0\F0s.xneko.c9%H$r9T$$$^$9!#(Quit !D Alt-Q)\n" );
    fprintf( stderr, "\n" );
    fprintf( stderr, "\t%-!<C%I>e$Ns.xneko.cs%-!<$GG-$r0\F0$5$;$F2<$5$$!#\n" );
...
ProcessDebugMenu()
{
    ...
    fprintf( stderr, "\n" );
    fprintf( stderr, "!Zxneko 05/31/93P15280%a%K%e!<![\n" );

    while ( !( UserSelectNo >= 1 && UserSelectNo <= 2 ) ) {
	fprintf( stderr, "\n" );
	fprintf( stderr, "\t1)!!G-%-%c%i%/%?!<0lMwI=<(\n" );
	fprintf( stderr, "\t2)!!G-0\F0s.xneko.c9%H\n" );
	fprintf( stderr, "\n" );
